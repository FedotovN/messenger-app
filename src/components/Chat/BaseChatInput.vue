<template>
  <div class="flex flex-col max-w-full">
    ...
    class="flex sm:max-w-[calc(100vw_-_22.75rem)] m-0 p-2 dark:text-gray-300 text-gray-600 whitespace-wrap overflow-auto bg-gray-200 dark:bg-gray-700 sm:bg-transparent outline-none scrollbar-hide resize-none m-0 focus:bg-gray-200 dark:focus:bg-gray-700 transition-colors"
    ref="textarea"
    :value="modelValue"
